...
<?php } ?>
			...
			<div id="header">
				<h1><a href=".">VoZP Telefonní seznam</a></h1>
				<a href="."><img src="<?php echo $url_images; ?>title_x2.png" width=340 height=60  title="VoZP Telefonní seznam" alt="VoZP Telefonní seznam" id="logo" /></a>
			</div>
			<div id="nav">
